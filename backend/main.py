...
<head>
    ...
    <style>
        ...
        .problem { margin: 30px 0; padding: 20px; border: 1px solid #ddd; border-radius: 8px; }
...
<body>
    ...
    <p>Total Questions: """ + str(len(problems)) + """</p>
"""
    ...
    <div class="problem">
        ...
        <div class="options">
            <div class="option">A) {problem.options.A}</div>
            <div class="option">B) {problem.options.B}</div>
            <div class="option">C) {problem.options.C}</div>
            <div class="option">D) {problem.options.D}</div>
        </div>
        <p><em>Correct Answer: {problem.correct_answer}</em></p>
    </div>
"""
